...
| `/2.9/app/sign_up_moments/current`             | GET    | Get the current sign up moment for Het Geluid. This changes every day and is required as you need the returned ID to register yourself for the game of the current day. Registering for the next day starts at 18:30 of the day before and ends at 18:30 the day of. | -                            |
